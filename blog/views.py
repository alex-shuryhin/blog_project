...
from blog.forms import CategoryForm, PageForm, UserForm, UserProfileForm
...
def profile(request):
    ...
    return render(request, 'blog/profile.html', context_dict)
...
def index(request):
    ...
    best_pages = Page.objects.order_by('-likes')[:5]
    context_dict = {'categories': categories_list, 'pages': best_pages}
...
def about(request):
    context_dict = {'about_message': "Blog says WOW: here is the about page."}
